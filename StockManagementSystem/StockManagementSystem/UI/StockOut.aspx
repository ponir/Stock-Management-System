    ...
    <form id="form1" runat="server">
        <div class="containt">
            <fieldset>
                ...
                <table>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="addButton" runat="server" Text="Add" Style="margin-left: 69px" OnClick="addButton_Click" Width="70px" Height="35px" BackColor="#33CC33" /></td>
                    </tr>
                </table>
            ...
            <Columns>
                ...
                <br/><br/>
                <asp:GridView ID="stockOutGridView" runat="server" AutoGenerateColumns="False" CellPadding="4" Height="35px" Width="425px" ForeColor="#333333" GridLines="None">
                ...
                <table style="margin-left: 304px">
                    <tr>
                        <td>
                            ...
                            <asp:Button ID="sellButton" runat="server" Text="Sell" OnClick="sellButton_Click" Style="margin-left: 0px" Height="37px" Width="70px" BackColor="#FF66CC" />

                        </td>
                        <td>
                            <asp:Button ID="damageButton" runat="server" Text="Damage" OnClick="damageButton_Click" Height="37px" BackColor="#FF0066" /></td>
                        <td>
                            <asp:Button ID="lostButton" runat="server" Text="Lost" OnClick="lostButton_Click" Height="35px" Width="70px" BackColor="#FF3300" /></td>
                    </tr>
                </table>
            </fieldset>
        </div>
