            ...
            <fieldset>
                ...
                <table>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <asp:Calendar ID="fromDateCalendar" runat="server" BackColor="White" BorderColor="White" BorderWidth="1px" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" Height="190px" VisibleDate="2018-05-04" Width="350px" OnSelectionChanged="fromDateCalendar_SelectionChanged" NextPrevFormat="FullMonth">
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <asp:Calendar ID="toDateCalendar" runat="server" BackColor="White" BorderColor="White" BorderWidth="1px" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" Height="190px" VisibleDate="2018-05-04" Width="350px" OnSelectionChanged="toDateCalendar_SelectionChanged" NextPrevFormat="FullMonth">
                                <DayHeaderStyle Font-Bold="True" Font-Size="8pt" />
                                <NextPrevStyle Font-Size="8pt" ForeColor="#333333" Font-Bold="True" VerticalAlign="Bottom" />
                                <OtherMonthDayStyle ForeColor="#999999" />
                                <SelectedDayStyle BackColor="#333399" ForeColor="White" />
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <asp:Button ID="Button1" runat="server" Text="Search" Style="margin-left: 95px" Width="87px" OnClick="Button1_Click" Height="32px" BackColor="#3399FF" /></td>
                    </tr>
